    ...
    <>
      ...
      <html lang="en" suppressHydrationWarning={true}>
        <body className={dmSans.className}>
          <DarkModeProvider>
            <Navbar />
            <main className="flex min-h-fit max-w-screen flex-col items-center justify-center px-6 md:px-24 dark:text-stone-100 bg-fixed bg-gradient-to-t from-slate-200 to-slate-100 dark:bg-gradient-to-t dark:from-indigo-950 from-25% dark:to-sky-800">
              {children}
            </main>
          </DarkModeProvider>
        </body>
